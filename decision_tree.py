...
# Calcualte euclidian distance between point1 and point2
...
# Find k-nearest neighbor and count the number of labels and predict based on that.
...
if __name__ == "__main__":
    ...
    # DTmodel.traverse(DTmodel)
    # KNN_model = trainKNN(train_matrix, 0, len(attri_dict))
    # KNN_values = predictKNN(test_matrix, KNN_model, len(attri_dict), label_dic, labels)
